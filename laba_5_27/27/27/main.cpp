...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/dev/project/Content/quad.obj")) {
            return false;
        }
        
        if (!m_billboardList.Init("C:/Users/NikASorokin/Desktop/123.png")) {
            return false;
        }
               
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/NikASorokin/Desktop/1.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/NikASorokin/Desktop/2.jpg");
